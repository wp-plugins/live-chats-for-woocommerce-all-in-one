	...
	function page_content(){
	  ...
	  <div class="wrap chats">
          ...
          <div class="item">
			...
			<div class="txtlabel">Widget ID <a href="http://www.zopim.com" target="_blank">don't have one? get on official site</a></div>
          ...
          <div class="item">
            ...
            <div class="txtlabel">Account ID <a href="http://www.olark.com" target="_blank">don't have one? get on official site</a></div>
			<form method="post" action="options.php">
			  <?php settings_fields( 'zm_chat_settings_group' ); ?>
